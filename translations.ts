...
const de: Translations = {
    ...
    chambre: "Kammer",
    linge: "Wäsche",
    standardTooltip: "Einfacher Brutto-/Hintergrundzählmodus.",
    ...
    chambreTooltip: "Berechnung für Kammer-/Portalmonitore.",
    ...
    grossCountTooltip: "Gesamtzahl der Impulse für die Probe oder Zählrate.",
    ...
    backgroundCountTooltip: "Gesamtzahl der Impulse für den Hintergrund oder Zählrate.",
    backgroundTimeTooltip: "Dauer der Hintergrundmessung in Sekunden.",
    calibration: "Kalibrierung",
    calibrationFactor: "Kalibrierfaktor (w)",
    calibrationFactorTooltip: "Faktor zur Umrechnung der Nettozählrate (c/s) in Aktivität (Bq).",
    autoCalibFactor: "Auto-Kalib.-Faktor (w)",
    autoCalibFactorTooltip: "Berechnet den Kalibrierfaktor automatisch basierend auf Detektoreffizienz und Fläche.",
    calibrationFactorUnit: "Einheit des Faktors",
    ...
    k1alpha: "k(1-α)",
    k1alphaTooltip: "Quantil der Normalverteilung für die Fehlerwahrscheinlichkeit 1. Art α (Falsch positiv). Üblicherweise 1,645 für α=5%.",
    k1beta: "k(1-β)",
    k1betaTooltip: "Quantil der Normalverteilung für die Fehlerwahrscheinlichkeit 2. Art β (Falsch negativ). Üblicherweise 1,645 für β=5%.",
    advancedParameters: "Erweiterte Parameter",
    correlationCoefficient: "Korrelationskoeffizient",
    correlationCoefficientTooltip: "Korrelationskoeffizient zwischen Hintergrund und Kalibrierfaktor. Oft 0.",
    bayesianCalculationMode: "Bayes'scher Berechnungsmodus",
    bayesianCalculationModeTooltip: "Verwendet einen Bayes'schen Ansatz zur Aktivitätsschätzung.",
    monteCarloMode: "Monte-Carlo-Modus",
    enableMonteCarlo: "Monte-Carlo aktivieren",
    enableMonteCarloTooltip: "Verwendet Monte-Carlo-Simulationen zur Unsicherheitsfortpflanzung.",
    numSimulations: "Anzahl der Simulationen",
    numSimulationsTooltip: "Anzahl der Iterationen für die Monte-Carlo-Simulation.",
    
    roiMeasurement: "ROI-Messung",
    roiGrossCount: "ROI Bruttozählrate",
    roiGrossCountTooltip: "Gesamtzahl der Impulse in der Region of Interest (ROI).",
    roiChannels: "ROI Breite (Kanäle)",
    roiChannelsTooltip: "Anzahl der Kanäle in der ROI.",
    backgroundTotalCount: "Gesamt-Hintergrundimpulse",
    ...
    probeEfficiencyTooltip: "2π oder 4π Effizienz der Sonde.",
    probeArea: "Sondenfläche (cm²)",
    probeAreaTooltip: "Detektionsfläche der Sonde in cm².",
    measurementConditions: "Messbedingungen",
    estimatedBackgroundRate: "Geschätzte Hintergrundrate (c/s)",
    estimatedBackgroundRateTooltip: "Erwartete durchschnittliche Hintergrundzählrate.",
    targetActivity: "Zielaktivität",
    targetValue: "Zielwert",
    targetValueTooltip: "Die Aktivität, die das System erkennen muss.",
    ...
    detectorDimLengthTooltip: "Detektorabmessung in Bewegungsrichtung.",
    detectorDimWidth: "Breite (cm)",
    detectorDimWidthTooltip: "Detektorabmessung quer zur Bewegungsrichtung.",
    conveyorSetup: "Förderbandeinrichtung",
    conveyorSpeed: "Fördergeschwindigkeit",
    conveyorSpeedTooltip: "Geschwindigkeit des Förderbands.",

    results: "Ergebnisse",
    resultUnit: "Einheit",
    primaryResult: "Nettoergebnis (y)",
    primaryResultTooltip: "Beste Schätzung der Nettoaktivität und deren Unsicherheit.",
    mcPrimaryResultTooltip: "Mittelwert der Monte-Carlo-Verteilung und Standardabweichung.",
    decisionThreshold: "Erkennungsgrenze (y*)",
    decisionThresholdTooltip: "Kritischer Wert. Wenn Nettoergebnis > y*, ist Aktivität vorhanden.",
    detectionLimit: "Nachweisgrenze (y#)",
    detectionLimitTooltip: "Kleinste zuverlässig nachweisbare Aktivität.",
    meanTimeBetweenFalseAlarms: "Mittlere Zeit zwischen Fehlalarmen",
    meanTimeBetweenFalseAlarmsTooltip: "Geschätzte mittlere Zeit zwischen Falschalarmen.",
    ...
    bestEstimateTooltip: "Konfidenzintervall (k=2) für die Aktivität, nur berechnet wenn nachgewiesen.",
    confidenceInterval: "Konfidenzintervall (95%)",
    confidenceIntervalTooltip: "Intervall, in dem der wahre Wert mit 95% Wahrscheinlichkeit liegt.",
    uncertaintyBudget: "Unsicherheitsbudget",
    uncertaintyBudgetTooltip: "Relativer Beitrag jeder Komponente zur Gesamtunsicherheit.",
    budgetCalibrationTooltip: "Diese Komponente hängt vom Nettoergebnis ab.",
    sensitivityCoefficients: "Sensitivitätskoeffizienten",
    sensitivityCoefficientsTooltip: "Zeigt, wie sich eine Änderung einer Eingabe auf das Ergebnis auswirkt.",
    coeff_gross_tooltip: "Sensitivität bezüglich Bruttozählrate.",
    coeff_bkg_tooltip: "Sensitivität bezüglich Hintergrundrate.",
    coeff_calib_tooltip: "Sensitivität bezüglich Kalibrierfaktor.",
    probabilityEffectPresent: "Wahrscheinlichkeit des Vorhandenseins",
    probabilityEffectPresentTooltip: "Wahrscheinlichkeit (P(μ > 0)), dass Aktivität vorhanden ist (Bayes).",
    detectionLimitMode: "Berechnungsmodus",
    targetDetectionLimit: "Zielnachweisgrenze",
    targetDetectionLimitTooltip: "Zielnachweisgrenze eingeben. k(1-β) wird angepasst.",
    calculate: "Berechnen",
    target: "Ziel",
    
    chartTitle: "Grafische Darstellung",
    chartDescription: "Dieses Diagramm veranschaulicht die Wahrscheinlichkeitsverteilungen für die Nullhypothese (H₀), die Alternativhypothese (H₁) und die aktuelle Messung.",
    ...
    analysisTypeTooltip: "Strahlungsart wählen. Filtert die Nuklidbibliothek.",
    identificationTolerance: "Identifikationstoleranz",
    identificationToleranceTooltip: "Fenster in keV (+/-) für die Nuklid-Suche.",
    interactiveModeTooltip: "Interaktiver Modus: Klick auf Spektrum fügt Peak hinzu.",
    yAxisZoomTooltip: "Passt die Y-Achsen-Skalierung an.",
    yAxisClippingTooltip: "Schneidet hohe Peaks ab, um die Basislinie besser zu sehen.",
    roiSelectionTooltip: "Klicken und Ziehen, um ROI auszuwählen.",
...
const es: Translations = {
    ...
    chambreTooltip: "Cálculo para monitores de cámara/portal.",
    lingeTooltip: "Cálculo para monitores de lavandería.",

    inputs: "Entradas",
    expertMode: "Modo Experto",
    sourceMeasurement: "Medición de fuente",
    grossCount: "Conteo Bruto",
    grossCountTooltip: "Cuentas totales de la muestra o tasa de conteo.",
    ...
    backgroundCountTooltip: "Cuentas totales del fondo o tasa de conteo.",
    backgroundTimeTooltip: "Duración de la medición del fondo.",
    calibration: "Calibración",
    calibrationFactor: "Factor de calibración (w)",
    calibrationFactorTooltip: "Factor para convertir tasa neta (c/s) a actividad (Bq).",
    autoCalibFactor: "Auto Calc Factor (w)",
    autoCalibFactorTooltip: "Calcula factor automáticamente basado en eficiencia y área.",
    calibrationFactorUnit: "Unidad del factor",
    calibrationFactorUnitTooltip: "Unidad del factor. Ej: Bq/(c/s).",
    relativeUncertainty: "Incertidumbre Relativa (u_rel(w))",
    relativeUncertaintyTooltip: "Incertidumbre relativa del factor en porcentaje.",
    riskParameters: "Parámetros de riesgo",
    k1alpha: "k(1-α)",
    k1alphaTooltip: "Cuantil normal para error tipo I (Falso positivo). Usualmente 1.645 para α=5%.",
    k1beta: "k(1-β)",
    k1betaTooltip: "Cuantil normal para error tipo II (Falso negativo). Usualmente 1.645 para β=5%.",
    advancedParameters: "Parámetros avanzados",
    correlationCoefficient: "Coeficiente de correlación",
    correlationCoefficientTooltip: "Coeficiente de correlación entre fondo y calibración. A menudo 0.",
    bayesianCalculationMode: "Modo de cálculo bayesiano",
    bayesianCalculationModeTooltip: "Usa enfoque bayesiano para estimación de actividad.",
    monteCarloMode: "Modo Monte Carlo",
    enableMonteCarlo: "Activar Monte Carlo",
    enableMonteCarloTooltip: "Usa simulación Monte Carlo para propagación de incertidumbre.",
    numSimulations: "Número de simulaciones",
    numSimulationsTooltip: "Número de iteraciones para la simulación.",
    
    roiMeasurement: "Medición ROI",
    roiGrossCount: "Conteo Bruto ROI",
    roiGrossCountTooltip: "Cuentas totales en la ROI.",
    ...
    probeParameters: "Parámetros de sonda",
    probeEfficiency: "Eficiencia de sonda (%)",
    probeEfficiencyTooltip: "Eficiencia 2π o 4π de la sonda.",
    probeArea: "Área de sonda (cm²)",
    probeAreaTooltip: "Área de detección de la sonda en cm².",
    measurementConditions: "Condiciones de medición",
    estimatedBackgroundRate: "Tasa de fondo estimada (c/s)",
    estimatedBackgroundRateTooltip: "Tasa de fondo promedio esperada.",
    targetActivity: "Actividad Objetivo",
    targetValue: "Valor Objetivo",
    targetValueTooltip: "La actividad que el sistema debe detectar.",
    ...
    detectorDimLengthTooltip: "Longitud del detector en dirección del movimiento.",
    detectorDimWidth: "Anchura (cm)",
    detectorDimWidthTooltip: "Anchura del detector perpendicular al movimiento.",
    conveyorSetup: "Configuración transportadora",
    conveyorSpeed: "Velocidad transportadora",
    conveyorSpeedTooltip: "Velocidad de la cinta transportadora.",

    results: "Resultados",
    resultUnit: "Unidad",
    primaryResult: "Resultado Neto (y)",
    primaryResultTooltip: "Mejor estimación de actividad neta e incertidumbre.",
    mcPrimaryResultTooltip: "Media y desviación estándar de Monte Carlo.",
    decisionThreshold: "Umbral de decisión (y*)",
    decisionThresholdTooltip: "Valor crítico. Si resultado > y*, hay actividad.",
    detectionLimit: "Límite de detección (y#)",
    detectionLimitTooltip: "Mínima actividad detectable con fiabilidad.",
    meanTimeBetweenFalseAlarms: "Tiempo medio entre falsas alarmas",
    meanTimeBetweenFalseAlarmsTooltip: "Tiempo medio estimado entre falsas alarmas.",
    conclusion: "Conclusión",
    effectPresent: "Actividad detectada (y > y*)",
    effectNotPresent: "No se detectó actividad (y ≤ y*)",
    bestEstimate: "Mejor estimación",
    bestEstimateTooltip: "Intervalo de confianza (k=2), calculado solo si se detecta actividad.",
    confidenceInterval: "Intervalo de confianza (95%)",
    confidenceIntervalTooltip: "Intervalo donde se encuentra el valor verdadero con 95% de probabilidad.",
    uncertaintyBudget: "Presupuesto de incertidumbre",
    uncertaintyBudgetTooltip: "Contribución relativa de cada componente a la varianza.",
    budgetCalibrationTooltip: "Esta componente depende del resultado neto.",
    sensitivityCoefficients: "Coeficientes de sensibilidad",
    sensitivityCoefficientsTooltip: "Muestra cómo afecta cada entrada al resultado.",
    coeff_gross_tooltip: "Sensibilidad a tasa bruta.",
    coeff_bkg_tooltip: "Sensibilidad a tasa de fondo.",
    coeff_calib_tooltip: "Sensibilidad a factor de calibración.",
    probabilityEffectPresent: "Probabilidad de presencia",
    probabilityEffectPresentTooltip: "Probabilidad (P(μ > 0)) de que exista actividad (Bayes).",
    detectionLimitMode: "Modo de cálculo",
    targetDetectionLimit: "Límite de detección objetivo",
    targetDetectionLimitTooltip: "Ingrese límite objetivo. Se ajustará k(1-β).",
    calculate: "Calcular",
    target: "Objetivo",
    
    chartTitle: "Representación Gráfica",
    chartDescription: "Este gráfico ilustra las distribuciones de probabilidad para la hipótesis nula (H₀), la hipótesis alternativa (H₁) y la medición actual.",
    viewSimulationStats: "Estadísticas",
    viewSimulationStatsTooltip: "Ver estadísticas detalladas de MC.",
    expandChartTooltip: "Ampliar gráfico",
    ...
    analysisTypeTooltip: "Seleccionar tipo de radiación para filtrar biblioteca.",
    identificationTolerance: "Tolerancia de identificación",
    identificationToleranceTooltip: "Ventana en keV (+/-) para búsqueda.",
    interactiveModeTooltip: "Modo interactivo: clic en espectro para añadir pico.",
    yAxisZoomTooltip: "Ajusta escala eje Y.",
    yAxisClippingTooltip: "Recorta picos altos para ver mejor la base.",
    roiSelectionTooltip: "Clic y arrastrar para seleccionar ROI.",
