...
const fr: Translations = {
    ...
    guide_intro_p1: "Cet assistant est un outil pédagogique et pratique pour appliquer les concepts de la norme ISO 11929. Il aide à calculer les limites caractéristiques (seuil de décision, limite de détection) et à comprendre l'impact des différents paramètres.",
    ...
    guide_spec_analyzer_p1: "Extrait des données d'une image de spectre (capture d'écran ou photo).",
    ...
    guide_n42_analyzer_li3: "Identification des radionucléides.",
...
const de: Translations = {
    ...
    guide_intro_p1: "Dieser Assistent ist ein pädagogisches und praktisches Werkzeug zur Anwendung der Konzepte der Norm ISO 11929. Er hilft bei der Berechnung charakteristischer Grenzen (Entscheidungsschwelle, Nachweisgrenze) und beim Verständnis der Auswirkungen verschiedener Parameter.",
    ...
    guide_n42_analyzer_p1: "Lädt und visualisiert ANSI N42.42 Standarddateien.",
    ...
    guide_source_mgmt_p1: "Verwalten Sie Ihr Prüfquelleninventar.",
    guide_source_mgmt_li1: "Quellen hinzufügen/bearbeiten/löschen.",
    guide_source_mgmt_li2: "Automatische Berechnung der aktuellen Aktivität (Zerfall).",
    guide_source_mgmt_li3: "Konformitätsprüfung gegen Standardtypen (S1, S2, usw.).",
    guide_source_mgmt_li4: "CSV Import/Export.",
...
const es: Translations = {
    ...
    guide_intro_p1: "Este asistente es una herramienta educativa y práctica para aplicar los conceptos de la norma ISO 11929. Ayuda a calcular los límites característicos (umbral de decisión, límite de detección) y a comprender el impacto de diferentes parámetros.",
    ...
    guide_n42_analyzer_p1: "Carga y visualiza archivos estándar ANSI N42.42.",
    guide_n42_analyzer_li1: "Visualización interactiva (zoom, escala log).",
    guide_n42_analyzer_li2: "Detección automática de picos.",
    guide_n42_analyzer_li3: "Identificación de radionucleidos.",
    guide_n42_analyzer_li4: "Sustracción de fondo y comparación.",
    guide_source_mgmt_title: "Gestión de Fuentes",
    guide_source_mgmt_p1: "Administre su inventario de fuentes de verificación.",
    guide_source_mgmt_li1: "Añadir/Editar/Eliminar fuentes.",
    guide_source_mgmt_li2: "Cálculo automático de actividad actual (decaimiento).",
    guide_source_mgmt_li3: "Verificación de conformidad contra tipos estándar (S1, S2, etc.).",
    ...
    fileDesc_analysisHelpers: "Utils análisis.",
