                    ...
                    <Card title={t('fileInfoAndSettings')}>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-700">
                            <div className="flex items-center space-x-2 p-1 bg-gray-900/50 rounded-lg">
                                ...
                                <button disabled title={`${t('exportHdf5')} (coming soon)`} className="flex-1 text-sm text-gray-500 flex items-center justify-center space-x-2 px-3 py-1 rounded-md cursor-not-allowed">
                                    <span>HDF5</span>
                                </button>
                                <button disabled title={`${t('exportNetCdf')} (coming soon)`} className="flex-1 text-sm text-gray-500 flex items-center justify-center space-x-2 px-3 py-1 rounded-md cursor-not-allowed">
                                    <span>NetCDF</span>
                                </button>
                            </div>
                        </div>
